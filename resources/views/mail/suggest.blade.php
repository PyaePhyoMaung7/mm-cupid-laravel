...
<head>
    ...
    <title>{{ $mail_data['company_name'] }}Partner Suggestion</title>
    <style>
        .button {
        ...
        <div style="margin: 20px;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
                <div style="margin-right: 20px;">
                    <h3 style="font-size: 1.25rem;">Partner For Life</h3>
                </div>
            ...
            <div>
                <p>
                    We hope this message finds you well. At {{ $mail_data['company_name']}}, our goal is to help you find meaningful connections that align with your preferences.
                </p>
                <p>
                    Based on your profile settings, we've found {{ $mail_data['username']}} who fit your criteria of gender preference and age range.
                </p>
            </div>

            <div>
                <div style="width: 100px; height: 150px; margin: 0 auto;">
                    <img style="width: 100%; height: 100%; object-fit: cover;" src="https://www.japantimes.co.jp/uploads/imported_images/uploads/2021/05/np_file_88021.jpeg" alt="">
                </div>
                <div style="text-align: center;">
                    <h4>{{ $mail_data['username'], $mail_data['age'] }}</h4>
                </div>
            </div>
            <div style="margin: 20px 0;">
                <div style="text-align: center; margin: 35px 0;">
                    <a href="{{ $mail_data['link'] }}" class="button" target="_blank">
                        View profile
                    </a>
                </div>
            </div>
