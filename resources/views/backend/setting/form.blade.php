                ...
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br />
                            @if (isset($setting))
                                <form id="demo-form2" action="{{ route('setting.update') }}" class="form-horizontal form-label-left"
                                    method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="id" value="{{ $setting->id }}">
                            @else
                                <form id="demo-form2" action="{{ route('setting.store') }}" class="form-horizontal form-label-left"
                                    method="POST" enctype="multipart/form-data">
                            @endif
                                ...
                                @csrf
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <input type="number" id="point" name="point" value="{{ old('point', isset($setting) ? $setting->point : '' ) }}" class="form-control" placeholder="Enter points">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <input type="text" id="company-name" name="company-name" value="{{ old('company-name', isset($setting) ? $setting->company_name : '' ) }}" class="form-control" placeholder="Enter company name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <input type="text" id="company-email" name="company-email" value="{{ old('company-email', isset($setting) ? $setting->company_email : '' ) }}" class="form-control" placeholder="Enter company email">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <input type="text" id="company-phone" name="company-phone" value="{{ old('company-phone', isset($setting) ? $setting->company_phone : '' ) }}" class="form-control" placeholder="Enter company phone">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <input type="text" id="company-address" name="company-address" value="{{ old('company-address', isset($setting) ? $setting->company_address : '' ) }}" class="form-control" placeholder="Enter company address">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div id="preview-image" class="overflow-hidden" style="border:1px dashed grey; border-radius: 10px; width: 300px; height: 300px;">
                                                @if (isset($setting))
                                                    <img src="{{ url('assets/default_images/'.$setting->company_logo) }}" class="w-100 h-100" style="object-fit: cover" alt="Image Preview" onclick="browseImage()"/>
                                                @else
                                            ...
                                            <input class="d-none" type="file" id="company-logo" name="company-logo" onchange="previewImage()" value="" class="form-control" placeholder="Enter company logo">
                                        </div>
                                    </div>
